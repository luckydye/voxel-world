	...
	get faces() {
		...
		return {
			TOP: [
				...
				s * w + x, s * w + y, -s * h + z, 0.9375 + u, 0.0625 + v,
				-s * w + x, s * w + y, -s * h + z, 0.0625 + u, 0.0625 + v,
				s * w + x, s * w + y, s * h + z, 0.9375 + u, 0.9375 + v,
				-s * w + x, s * w + y, -s * h + z, 0.0625 + u, 0.0625 + v,
				-s * w + x, s * w + y, s * h + z, 0.0625 + u, 0.9375 + v,
			],
			BOTTOM: [
				s * w + x, -s * w + y, s * h + z, 0.9375 + u, 0.9375 + v,
				s * w + x, -s * w + y, -s * h + z, 0.9375 + u, 0.0625 + v,
			...
			LEFT: [
				s * w + x, s * h + y, s * w + z, 0.9375 + u, 0.9375 + v,
				s * w + x, -s * h + y, s * w + z, 0.9375 + u, 0.0625 + v,
				-s * w + x, -s * h + y, s * w + z, 0.0625 + u, 0.0625 + v,
				s * w + x, s * h + y, s * w + z, 0.9375 + u, 0.9375 + v,
				-s * w + x, -s * h + y, s * w + z, 0.0625 + u, 0.0625 + v,
				-s * w + x, s * h + y, s * w + z, 0.0625 + u, 0.9375 + v,
			],
			RIGHT: [
				s * w + x, s * h + y, -s * w + z, 0.9375 + u, 0.9375 + v,
				s * w + x, -s * h + y, -s * w + z, 0.9375 + u, 0.0625 + v,
