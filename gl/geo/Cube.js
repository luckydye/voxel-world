...
export class Cube extends Geometry {
	...
	get faces() {
		...
		return {
			TOP: [
				s * w + x, s * w + y, s * h + z, 0.8 + u, 0.8 + v,
				s * w + x, s * w + y, -s * h + z, 0.8 + u, 0.2 + v,
				-s * w + x, s * w + y, -s * h + z, 0.2 + u, 0.2 + v,
				s * w + x, s * w + y, s * h + z, 0.8 + u, 0.8 + v,
				-s * w + x, s * w + y, -s * h + z, 0.2 + u, 0.2 + v,
				-s * w + x, s * w + y, s * h + z, 0.2 + u, 0.8 + v,
			],
			BOTTOM: [
				s * w + x, -s * w + y, s * h + z, 0.8 + u, 0.8 + v,
				s * w + x, -s * w + y, -s * h + z, 0.8 + u, 0.2 + v,
			...
			LEFT: [
				s * w + x, s * h + y, s * w + z, 0.8 + u, 0.8 + v,
				s * w + x, -s * h + y, s * w + z, 0.8 + u, 0.2 + v,
				-s * w + x, -s * h + y, s * w + z, 0.2 + u, 0.2 + v,
				s * w + x, s * h + y, s * w + z, 0.8 + u, 0.8 + v,
				-s * w + x, -s * h + y, s * w + z, 0.2 + u, 0.2 + v,
				-s * w + x, s * h + y, s * w + z, 0.2 + u, 0.8 + v,
			],
			RIGHT: [
				s * w + x, s * h + y, -s * w + z, 0.8 + u, 0.8 + v,
				s * w + x, -s * h + y, -s * w + z, 0.8 + u, 0.2 + v,
