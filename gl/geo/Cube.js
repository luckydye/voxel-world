...
export class Cube extends Geometry {
	...
	get faces() {
		...
		return {
			TOP: [
				s * w + x, s * w + y, s * h + z, 0.9 + u, 0.9 + v,
				s * w + x, s * w + y, -s * h + z, 0.9 + u, 0.1 + v,
				-s * w + x, s * w + y, -s * h + z, 0.1 + u, 0.1 + v,
				s * w + x, s * w + y, s * h + z, 0.9 + u, 0.9 + v,
				-s * w + x, s * w + y, -s * h + z, 0.1 + u, 0.1 + v,
				-s * w + x, s * w + y, s * h + z, 0.1 + u, 0.9 + v,
			],
			BOTTOM: [
				s * w + x, -s * w + y, s * h + z, 0.9 + u, 0.9 + v,
				s * w + x, -s * w + y, -s * h + z, 0.9 + u, 0.1 + v,
			...
			LEFT: [
				s * w + x, s * h + y, s * w + z, 0.9 + u, 0.9 + v,
				s * w + x, -s * h + y, s * w + z, 0.9 + u, 0.1 + v,
				-s * w + x, -s * h + y, s * w + z, 0.1 + u, 0.1 + v,
				s * w + x, s * h + y, s * w + z, 0.9 + u, 0.9 + v,
				-s * w + x, -s * h + y, s * w + z, 0.1 + u, 0.1 + v,
				-s * w + x, s * h + y, s * w + z, 0.1 + u, 0.9 + v,
			],
			RIGHT: [
				s * w + x, s * h + y, -s * w + z, 0.9 + u, 0.9 + v,
				s * w + x, -s * h + y, -s * w + z, 0.9 + u, 0.1 + v,
